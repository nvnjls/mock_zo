...
const StatsComponent = () => {
    return (
        <div className="my-20 px-4 sm:px-8 md:px-16 py-8 bg-background">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 items-center">
                    ...
                    <div className="lg:w-1/2 relative">
                        ...
                        <div className="absolute top-2 left-2 w-full h-full flex items-top justify-left rounded-xl">
                            <p className="text-textImportant font-bold text-4xl sm:text-5xl md:text-6xl text-center p-4">
                                Only <span className="text-alert">4</span> out of 100 students get placed on average India wide
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/2 space-y-8 sm:space-y-10">
                        {/* Stat 1 - Anxiety */}
                        <div className="stats bg-foreground border-2 border-error/20 shadow-lg hover:shadow-xl transition-shadow w-full">
                            <div className="stat">
                ...
                <div className="text-center mt-12 sm:mt-16 space-y-4 sm:space-y-6">
                    ...
                    <button className="btn bg-primary btn-lg text-textImportant px-6 py-3 sm:px-8 sm:py-4">
